...
public class CheckHotels extends JFrame implements Runnable{
    ...
    public void run() {
        ...
        String[]  text = new String[] {"Rosewood Hong Kong","Aman Venice","The Connaught","The Ritz Hotel","Raffles","Beverly Hills Hotel","La Mamounia","Soneva Fushi","The Calile","The Maybourne Riviera","Four Seasons Firenze", "Badrutt's Palace"};
    ...
    CheckHotels() {
        setBounds(380,0,900,750);
        
        caption = new JLabel();
        caption.setBounds(50, 20,800,30);
       caption.setFont(new Font("Times New Roman", Font.BOLD,25));
       ...
       add(caption);
        ...
        for (int i=0; i<=11; i++) {
         ...
         image[i] = new ImageIcon(ClassLoader.getSystemResource("icons2/hotel"+(i+1)+".jpg"));
        jimage[i] = image[i].getImage().getScaledInstance(900,750,Image.SCALE_DEFAULT);
        kimage[i] = new ImageIcon(jimage[i]);
        label[i] = new JLabel(kimage[i]);
        label[i].setBounds(0,0,900,750);
        add(label[i]);
